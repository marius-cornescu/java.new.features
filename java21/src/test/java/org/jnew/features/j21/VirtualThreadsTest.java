    ...
    static Stream<Arguments> variousValues() {
        return Stream.of(
                of("1 second SleepyRunnable IN SinglePlatformThread",
                        makeMeAOneSecondSeepyRunnable(), (Consumer<Runnable>)VirtualThreadsTest::runMeInAPlatformThread),

                of("1 second SleepyRunnable IN SingleVirtualThread",
                        makeMeAOneSecondSeepyRunnable(), (Consumer<Runnable>)VirtualThreadsTest::runMeInAVirtualThread),
